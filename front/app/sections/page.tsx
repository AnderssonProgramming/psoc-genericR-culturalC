...
Finalmente, el desarrollo de la **inteligencia emocional, la empatía y la expresión de sentimientos** no debe ser exclusivo de un género. Tanto hombres como mujeres tienen la capacidad biológica y psicológica de desarrollar estas habilidades. Sin embargo, la socialización tradicional ha generado consecuencias negativas en ambos: mientras a los hombres se les ha enseñado a reprimir sus emociones, afectando su salud mental y su capacidad para ejercer una paternidad activa, a las mujeres se les ha impuesto la expectativa de ser emocionalmente expresivas y cuidadoras, generando una **carga psicológica significativa**. Esta responsabilidad del trabajo emocional no remunerado, sumada a la sobrecarga de roles, la presión por cumplir estándares de belleza inalcanzables y la constante vigilancia social, contribuye a que las mujeres presenten mayores índices de **estrés crónico, ansiedad, depresión y síndrome del impostor**, especialmente en espacios profesionales donde la internalización de estereotipos les hace dudar persistentemente de sus capacidades a pesar de sus logros.
...
Finalmente, es importante destacar que este proyecto **fue desarrollado por estudiantes universitarios de diversas disciplinas —incluyendo ingenierías ambiental, civil, de sistemas, electrónica, estadística, industrial y mecánica, así como economía— bajo la orientación de un psicólogo profesional**. Esta colaboración interdisciplinaria enriquece la propuesta, demostrando que los roles de género son un tema que concierne a todas las disciplinas y que requiere del diálogo entre diversas áreas del conocimiento, así que, solo a través de esfuerzos colaborativos y comprometidos se llega hacia una sociedad verdaderamente igualitaria.
